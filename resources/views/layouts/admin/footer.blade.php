<div class="text-right">
  ...
  <script src="{{asset('admin/assets/js/jquery-ui-1.10.4.min.js')}}"></script>
  <script src="{{asset('admin/assets/js/jquery-1.8.3.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('admin/assets/js/jquery-ui-1.9.2.custom.min.js')}}"></script>
  <!-- bootstrap -->
  ...
  <<script src="{{asset('admin/assets/js/fullcalendar.min.js')}}"></script>
    ...
    <script src="{{asset('admin/assets/js/calendar-custom.js')}}"></script>
    <script src="{{asset('admin/assets/js/jquery.rateit.min.js')}}"></script>
    <!-- custom select -->
    ...
    <script src="{{asset('admin/assets/js/jquery-jvectormap-1.2.2.min.js')}}"></script>
    <script src="{{asset('admin/assets/js/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{asset('admin/assets/js/xcharts.min.js')}}"></script>
    <script src="{{asset('admin/assets/js/jquery.autosize.min.js')}}"></script>
    <script src="{{asset('admin/assets/js/jquery.placeholder.min.js')}}"></script>
    <script src="{{asset('admin/assets/js/gdp-data.js')}}"></script>
    <script src="{{asset('admin/assets/js/morris.min.js')}}"></script>
    <script src="{{asset('admin/assets/js/sparklines.js')}}"></script>
